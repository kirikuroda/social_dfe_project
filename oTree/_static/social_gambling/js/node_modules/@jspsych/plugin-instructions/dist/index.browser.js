      ...
      function show_current_page() {
        ...
        if (trial.show_clickable_nav) {
          ...
          if (trial.allow_backward) {
            ...
            nav_html += "<button id='jspsych-instructions-back' class='otree-btn-next btn btn-primary btn-lg' style='margin-right: 5px;' " + allowed + ">&lt; " + trial.button_label_previous + "</button>";
          }
          ...
          nav_html += "<button id='jspsych-instructions-next' class='otree-btn-next btn btn-primary btn-lg' style='margin-left: 5px;' " + allowed_next + ">" + trial.button_label_next + " &gt;</button></div>";
          html += nav_html;
